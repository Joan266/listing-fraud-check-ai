...
export const FailedAnalysis: React.FC<FailedAnalysisProps> = ({ analysis, onRerun}) => {
  const errorMessage = (analysis.final_report as any)?.error || "Ha ocurrido un error desconocido.";

  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center">
      <AlertTriangle className="w-16 h-16 text-red-500 mb-4" />
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Análisis fallido</h2>
